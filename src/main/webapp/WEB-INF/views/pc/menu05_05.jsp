	...
	<div id="wrap">
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					<td align="left" style="width: 50%;"><img src="${pageContext.request.contextPath}/resources/img/pc/content/title05_05.gif" border="0"></td>
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; 여드름ㆍ여드름흉터 &gt; <span class="home_1">여드름흉터</span></td>
				</tr>
    		  	<tr>
				...
				<tr>
					<td colspan="2"><a name="con0505_b1"></a><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0505_b1.jpg"></td>
				</tr>
				<tr>
					<td colspan="2"><a name="con0505_b2"></a><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0505_b2.jpg"></td>
				</tr>
				<tr>
