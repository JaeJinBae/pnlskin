...
<body>
	...
	<div id="wrap">
		...
		<div id="l_nav" style="float:left;">
			<div class="l_n_title">모공ㆍ흉터</div>
			<ul class="l_n_top">
				<li id="sb_01"><a href="${pageContext.request.contextPath}/menu06_01">모공</a></li>
				<li id="sb_02"><a href="${pageContext.request.contextPath}/menu06_02">흉터</a></li>
				<li id="sb_03"><a href="#none">켈로이드</a></li> <!-- 새 페이지? -->
				<li id="sb_04"><a href="${pageContext.request.contextPath}/menu06_04">튼살</a></li>
				<li id="sb_05"><a href="${pageContext.request.contextPath}/menu06_05">프락셀듀얼</a></li>
				<li id="sb_06"><a href="${pageContext.request.contextPath}/menu06_06">모자이크</a></li>
				<li id="sb_07"><a href="${pageContext.request.contextPath}/menu06_07">eco2</a></li>
				<li id="sb_08"><a href="${pageContext.request.contextPath}/menu06_08">이노젝터</a></li>
				<li id="sb_09"><a href="${pageContext.request.contextPath}/menu06_09">제네시스</a></li>
				<li id="sb_10"><a href="${pageContext.request.contextPath}/menu06_10">피코</a></li> <!-- 추가 페이지 -->
				<li id="sb_11"><a href="${pageContext.request.contextPath}/menu06_11">카프리</a></li> <!-- 추가 페이지 -->
				<li id="sb_12"><a href="${pageContext.request.contextPath}/menu06_12">마스터스</a></li>
				<li id="sb_13"><a href="${pageContext.request.contextPath}/menu06_13">디아지</a></li>
				<li id="sb_14"><a href="${pageContext.request.contextPath}/menu06_14">IPL</a></li>
				<li id="sb_15"><a href="${pageContext.request.contextPath}/menu06_15">아쿠아필</a></li>
				<li class="cbox"></li>
			</ul>
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					<td align="left" style="width: 50%;"><img src="${pageContext.request.contextPath}/resources/img/pc/content/title06_01.gif" border="0"></td>
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; 모공ㆍ흉터 &gt; <span class="home_1">모공</span></td>
				</tr>
    		  	<tr>
				...
				<tr>
					<td colspan="2" bgcolor="#feeeb0"><script type="text/javascript">flashWrite('${pageContext.request.contextPath}/resources/img/pc/content/pro_banner4.swf','660','302', 'always', 'transparent', '#ffffff', 'transparent');</script></td>
				</tr>
				<tr>
