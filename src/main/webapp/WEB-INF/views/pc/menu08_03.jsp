...
<body>
	...
	<div id="wrap">
		...
		<div id="l_nav" style="float:left;">
			<div class="l_n_title">안면홍조</div>
			<ul class="l_n_top">
				<li id="sb_01"><a href="${pageContext.request.contextPath}/menu08_01">안면홍조</a></li>
				<li id="sb_02"><a href="${pageContext.request.contextPath}/menu08_02">모세혈관확장</a></li>
				<li id="sb_03"><a href="${pageContext.request.contextPath}/menu08_03">엑셀브이레이저</a></li>
				<li id="sb_04"><a href="${pageContext.request.contextPath}/menu08_04">V-빔레이저</a></li>
				<li id="sb_05"><a href="${pageContext.request.contextPath}/menu08_05">제네시스</a></li>
				<li id="sb_06"><a href="#none">롱펄스엔디야그</a></li> <!-- 추가 페이지??? -->
				<li id="sb_07"><a href="${pageContext.request.contextPath}/menu08_07">피코</a></li> <!-- 추가 페이지 -->
				<li id="sb_08"><a href="${pageContext.request.contextPath}/menu08_08">LDM</a></li> <!-- 추가 페이지 -->
				<li class="cbox"></li>
			</ul>
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					...
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; 안면홍조 &gt; <span class="home_1">엑셀브이레이저 (EXCEL V)</span></td>
				</tr>
    		  	<tr>
