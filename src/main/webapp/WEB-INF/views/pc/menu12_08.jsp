...
<body>
	...
	<div id="wrap">
		...
		<div id="l_nav" style="float:left;">
			<div class="l_n_title">주사치료</div>
			<ul class="l_n_top">
				<li id="sb_01"><a href="${pageContext.request.contextPath}/menu12_01">백옥주사</a></li>
				<li id="sb_02"><a href="${pageContext.request.contextPath}/menu12_02">신데렐라주사</a></li>
				<li id="sb_03"><a href="${pageContext.request.contextPath}/menu12_03">물광주사</a></li>
				<li id="sb_04"><a href="${pageContext.request.contextPath}/menu12_04">보습주사</a></li>
				<li id="sb_05"><a href="${pageContext.request.contextPath}/menu12_05">태반주사</a></li>
				<li id="sb_06"><a href="${pageContext.request.contextPath}/menu12_06">맞춤영양주사</a></li>
				<li id="sb_07"><a href="${pageContext.request.contextPath}/menu12_07">샤넬동안주사</a></li>
				<li id="sb_08"><a href="${pageContext.request.contextPath}/menu12_08">땀주사</a></li>
				<li id="sb_09"><a href="#none">면역주사</a></li>
				<li class="cbox"></li>
			</ul>
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					<td align="left" style="width: 50%;"><img src="${pageContext.request.contextPath}/resources/img/pc/content/title10_03.gif" border="0"></td>
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; 주사치료 &gt; <span class="home_1">메조보톡스</span></td>
				</tr>
    		  	<tr>
    				<td colspan="2" height="25"></td>
    			</tr>
				<tr>
					<td colspan="2"><img src="${pageContext.request.contextPath}/resources/img/pc/content/con1003.jpg"></td>
				</tr>
