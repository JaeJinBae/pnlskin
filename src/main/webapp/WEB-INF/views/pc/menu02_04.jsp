...
<body>
	...
	<div id="wrap">
		...
		<div id="l_nav" style="float:left;">
			...
			<ul class="l_n_top">
				<li id="sb_01"><a href="${pageContext.request.contextPath}/menu02_01">One-day 리프팅</a></li>
				<li id="sb_02"><a href="${pageContext.request.contextPath}/menu02_02">Young Age 리프팅</a></li>
				<li id="sb_03"><a href="${pageContext.request.contextPath}/menu02_03">안면홍조 주사</a></li>
				<li id="sb_04"><a href="${pageContext.request.contextPath}/menu02_04">기미잡티색소치료</a></li>
				<li id="sb_05"><a href="${pageContext.request.contextPath}/menu02_05">여드름</a></li>
				<li id="sb_06"><a href="${pageContext.request.contextPath}/menu02_06">여드름흉터</a></li>
				<li id="sb_07"><a href="${pageContext.request.contextPath}/menu02_07">모공</a></li>
				<li id="sb_08"><a href="${pageContext.request.contextPath}/menu02_08">비만</a></li>
				<li id="sb_09"><a href="${pageContext.request.contextPath}/menu02_09">튼살치료</a></li>
				<li id="sb_10"><a href="${pageContext.request.contextPath}/menu02_10">스컬트라</a></li>
				<li class="cbox"></li>
			</ul>
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					<td align="left" style="width: 50%;"><img src="${pageContext.request.contextPath}/resources/img/pc/content/title02_04.gif" border="0"></td>
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; HOT 클리닉 &gt; <span class="home_1">기미잡티색소치료</span></td>
				</tr>
    		  	<tr>
    				<td colspan="2" height="25"></td>
    			</tr>
				<tr>
					<td colspan="2"><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0204.jpg"></td>
				</tr>
				<tr>
