...
<body>
	...
	<div id="wrap">
		...
		<div id="l_nav" style="float:left;">
			<div class="l_n_title">제모ㆍ비만</div>
			<ul class="l_n_top">
				<li id="sb_01"><a href="${pageContext.request.contextPath}/menu11_01">제모</a></li>
				<li id="sb_02"><a href="${pageContext.request.contextPath}/menu11_02">액취증ㆍ다한증</a></li>
				<li id="sb_03"><a href="${pageContext.request.contextPath}/menu11_03">사이저</a></li>
				<li id="sb_04"><a href="${pageContext.request.contextPath}/menu11_04">HPL</a></li>
				<li id="sb_05"><a href="${pageContext.request.contextPath}/menu11_05">PPC</a></li>
				<li id="sb_06"><a href="${pageContext.request.contextPath}/menu11_06">메조테라피</a></li>
				<li id="sb_07"><a href="${pageContext.request.contextPath}/menu11_07">카복시테라피</a></li>
				<li id="sb_08"><a href="${pageContext.request.contextPath}/menu11_08">클라투</a></li>
				<li id="sb_09"><a href="#none">브라질리언제모</a></li>
				<li class="cbox"></li>
			</ul>
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					<td align="left" style="width: 50%;"><img src="${pageContext.request.contextPath}/resources/img/pc/content/title11_02.gif" border="0"></td>
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; 제모ㆍ비만 &gt; <span class="home_1">액취증ㆍ다한증</span></td>
				</tr>
    		  	<tr>
    				<td colspan="2" height="25"></td>
    			</tr>
				<tr>
					<td colspan="2"><img src="${pageContext.request.contextPath}/resources/img/pc/content/con1102.jpg"></td>
				</tr>
