...
<body>
	...
	<div id="wrap">
		...
		<div id="l_nav" style="float:left;">
			<div class="l_n_title">쁘띠성형</div>
			<ul class="l_n_top">
				<li id="sb_01"><a href="${pageContext.request.contextPath}/menu10_01">보톡스</a></li>
				<li id="sb_02"><a href="${pageContext.request.contextPath}/menu10_02">필러</a></li>
				<li id="sb_03"><a href="${pageContext.request.contextPath}/menu10_03">메조보톡스</a></li>
				<li id="sb_04"><a href="${pageContext.request.contextPath}/menu10_04">리쥬란힐러</a></li>
				<li id="sb_05"><a href="${pageContext.request.contextPath}/menu10_05">물광주사</a></li>
				<li id="sb_06"><a href="${pageContext.request.contextPath}/menu10_06">스컬트라</a></li>
				<li id="sb_07"><a href="${pageContext.request.contextPath}/menu10_07">샤넬동안주사</a></li> <!-- 추가 페이지??? -->
				<li class="cbox"></li>
			</ul>
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					...
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; 쁘띠성형 &gt; <span class="home_1">메조보톡스</span></td>
				</tr>
    		  	<tr>
