	...
	<div id="wrap">
		...
		<div id="l_nav" style="float:left;">
			...
			<ul class="l_n_top">
				...
				<li id="sb_02"><a href="${pageContext.request.contextPath}/menu02_01">Young Age 리프팅</a></li>
				<li id="sb_03"><a href="${pageContext.request.contextPath}/menu02_01">안면홍조 주사</a></li>
				<li id="sb_04"><a href="${pageContext.request.contextPath}/menu02_01">기미잡티색소치료</a></li>
				<li id="sb_05"><a href="${pageContext.request.contextPath}/menu02_01">여드름</a></li>
				<li id="sb_06"><a href="${pageContext.request.contextPath}/menu02_01">여드름흉터</a></li>
				<li id="sb_07"><a href="${pageContext.request.contextPath}/menu02_01">모공</a></li>
				<li id="sb_08"><a href="${pageContext.request.contextPath}/menu02_01">비만</a></li>
				<li id="sb_09"><a href="${pageContext.request.contextPath}/menu02_01">튼살치료</a></li>
				<li id="sb_10"><a href="${pageContext.request.contextPath}/menu02_01">스컬트라</a></li>
				<li class="cbox"></li>
			</ul>
