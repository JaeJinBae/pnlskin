...
<body>
	...
	<div id="wrap">
		...
		<div id="l_nav" style="float:left;">
			<div class="l_n_title" style="letter-spacing:-5px;">여드름ㆍ여드름흉터</div>
			<ul class="l_n_top">
				<li id="sb_01"><a href="${pageContext.request.contextPath}/menu05_01">여드름</a></li>
				<li id="sb_02"><a href="${pageContext.request.contextPath}/menu05_02">성인여드름</a></li>
				<li id="sb_03"><a href="${pageContext.request.contextPath}/menu05_03">사춘기여드름</a></li>
				<li id="sb_04"><a href="${pageContext.request.contextPath}/menu05_04">바디여드름</a></li>
				<li id="sb_05"><a href="${pageContext.request.contextPath}/menu05_05">여드름흉터</a></li>
				<li id="sb_06"><a href="${pageContext.request.contextPath}/menu05_06">여드름자국</a></li>
				<li id="sb_07"><a href="${pageContext.request.contextPath}/menu05_07">프락셀듀얼</a></li>
				<li id="sb_08"><a href="${pageContext.request.contextPath}/menu05_08">모자이크</a></li>
				<li id="sb_09"><a href="${pageContext.request.contextPath}/menu05_09">eco2</a></li>
				<li id="sb_10"><a href="${pageContext.request.contextPath}/menu05_10">이노젝터</a></li>
				<li id="sb_11"><a href="${pageContext.request.contextPath}/menu05_11">엑셀브이레이저</a></li>
				<li id="sb_12"><a href="${pageContext.request.contextPath}/menu05_12">피코</a></li> <!-- 추가 페이지 -->
				<li id="sb_13"><a href="${pageContext.request.contextPath}/menu05_13">아그네스</a></li>
				<li id="sb_14"><a href="${pageContext.request.contextPath}/menu05_14">카프리</a></li> <!-- 추가 페이지 -->
				<li id="sb_15"><a href="${pageContext.request.contextPath}/menu05_15">PDT</a></li>
				<li id="sb_16"><a href="${pageContext.request.contextPath}/menu05_16">아쿠아필</a></li>
				<li id="sb_17"><a href="${pageContext.request.contextPath}/menu05_17">스케일링,필링</a></li>
				<li id="sb_18"><a href="${pageContext.request.contextPath}/menu05_18">해초필링</a></li>
				<li id="sb_19"><a href="#none">알라딘필</a></li>
				<li id="sb_20"><a href="#none">VSM</a></li>
				<li id="sb_21"><a href="#none">블랙필 호박필</a></li> <!-- 세부페이지 연결 다음에 -->
				<li class="cbox"></li>
			</ul>
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					<td align="left" style="width: 50%;"><img src="${pageContext.request.contextPath}/resources/img/pc/content/title05_04.gif" border="0"></td>
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; 여드름ㆍ여드름흉터 &gt; <span class="home_1">바디여드름</span></td>
				</tr>
    		  	<tr>
    				<td colspan="2" height="25"></td>
    			</tr>
				<tr>
					<td colspan="2"><img src="${pageContext.request.contextPath}/resources/img/pc/content/con05.jpg"></td>
				</tr>
				<tr>
					<td colspan="2" bgcolor="#ffe4ed"><script type="text/javascript">flashWrite('${pageContext.request.contextPath}/resources/img/pc/content/pro_banner3.swf','660','266', 'always', 'transparent', '#ffffff', 'transparent');</script><object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="660" height="266" id="always" align="middle"><param name="allowScriptAccess" value="always"><param name="movie" value="/work/_swf/pro_banner3.swf"><param name="FlashVars" value="#ffffff"><param name="wmode" value="transparent"><param name="menu" value="false"><param name="quality" value="high"><param name="bgcolor" value="transparent"><embed src="/work/_swf/pro_banner3.swf" flashvars="#ffffff" wmode="transparent" menu="false" quality="high" bgcolor="transparent" width="660" height="266" name="always" align="middle" allowscriptaccess="always" type="application/x-shockwave-flash" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash"></object></td>
				</tr>
				<tr>
					<td colspan="2" bgcolor="#ffe4ed" height="30"></td>
				</tr>
				<tr>
					<td colspan="2"><a name="con0504_b1"></a><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0504_b1.jpg"></td>
				</tr>
   				<tr>
					<td colspan="2"><a name="con0504_b2"></a><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0504_b2.jpg"></td>
				</tr>
				<tr>
