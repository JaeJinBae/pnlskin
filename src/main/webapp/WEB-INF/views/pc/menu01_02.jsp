...
<body>
	...
	<div id="wrap"><script>
		...
		<div id="l_nav" style="float:left;">
			...
			<ul class="l_n_top">
				<li id="sb_01"><a href="http://www.pnlskin.com/work/sub01/sub01.php?sb=01">인사말</a></li>
				<li id="sb_02" style="background: rgb(72, 198, 255);"><a href="http://www.pnlskin.com/work/sub01/sub01.php?sb=02" style="color: rgb(255, 255, 255);">의료진소개</a></li>
    ...
    <table width="740" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left"><img src="../_images/sub/title01_02.gif" border="0"></td>
        <td align="right" class="HOME"><img src="../_images/sub/home.gif" align="absmiddle"> &gt; 박앤리 &gt; <span class="home_1">의료진소개</span></td>
      </tr>
	  <tr>
			<td colspan="2" height="25"></td>
		</tr>
	   <tr>
        <td colspan="2"><img src="../_images/sub/con0102.jpg"></td>
      </tr>
    </tbody></table>
<!-- contents -->
<br><br>
...
</script><script src="http://cr.acecounter.com/Web/AceCounter_CW.js?gc=AR1F40118514478&amp;py=0&amp;gd=dgc19&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1576131176320" type="text/javascript"></script>
