...
<body>
	...
	<div id="wrap">
		...
		<div id="l_nav" style="float:left;">
			<div class="l_n_title">탈모</div>
			<ul class="l_n_top">
				<li id="sb_01"><a href="${pageContext.request.contextPath}/menu09_01">탈모</a></li>
				<li id="sb_02"><a href="${pageContext.request.contextPath}/menu09_02">모발이식</a></li>
				<li id="sb_03"><a href="${pageContext.request.contextPath}/menu09_03">흉터이식술</a></li>
				<li id="sb_04"><a href="${pageContext.request.contextPath}/menu09_04">메조테라피</a></li>
				<li id="sb_05"><a href="${pageContext.request.contextPath}/menu09_05">두피케어</a></li>
				<li class="cbox"></li>
			</ul>
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					<td align="left" style="width: 50%;"><img src="${pageContext.request.contextPath}/resources/img/pc/content/title09_01.gif" border="0"></td>
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; 탈모 &gt; <span class="home_1">탈모</span></td>
				</tr>
    		  	<tr>
    				<td colspan="2" height="25"></td>
    			</tr>
				<tr>
					<td colspan="2"><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0901.jpg"></td>
				</tr>
				<tr>
					<td colspan="2"><a name="con0901_b1"></a><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0901_b1.jpg"></td>
				</tr>
				<tr>
					<td colspan="2"><a name="con0901_b2"></a><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0901_b2.jpg"></td>
				</tr>
				<tr>
