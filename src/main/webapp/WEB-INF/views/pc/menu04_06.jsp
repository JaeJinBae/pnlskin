	...
	<div id="wrap">
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					<td align="left" style="width: 50%;"><img src="${pageContext.request.contextPath}/resources/img/pc/content/title04_06.gif" border="0"></td>
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; 기미ㆍ잡티 &gt; <span class="home_1">점</span></td>
				</tr>
    		  	<tr>
    				<td colspan="2" height="25"></td>
    			</tr>
    			<tr>
					<td colspan="2"><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0406.jpg"></td>
				</tr>
				<tr>
					<td colspan="2"><a name="con0406_b1"></a><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0406_b1.jpg"></td>
				</tr>
				<tr>
					<td colspan="2"><a name="con0406_b2"></a><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0406_b2.jpg"></td>
				</tr>
				<tr>
