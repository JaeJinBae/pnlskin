...
//$("#mask1").css({"height":$wh+"px","opacity":"0.7"});
		...
		<div id="header">
			<div id="hd_top">
				<ul class="fr">
					...
					<a href="http://www.pnlskin.com/work/sub01/sub01.php?sb=06&amp;bbs=press&amp;pg=list"><li><img src="/images/top_02.png" alt=""></li></a>
	...
	<div class="visual">
		...
		<div class="bx-wrapper" style="max-width: 100%;">
			<div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 475px;">
				<ul class="bxslider" id="bxslider01" style="opacity: 1; width: 715%; position: relative; transition-duration: 0s; transform: translate3d(-2656px, 0px, 0px);">
					<li style="float: left; list-style: none; position: relative; width: 1328px;" class="bx-clone"><img src="../banner/bn_61" alt=""></li>
					<li style="float: left; list-style: none; position: relative; width: 1328px;"><img src="../banner/bn_95" alt=""></li>
					<li style="float: left; list-style: none; position: relative; width: 1328px;"><img src="../banner/bn_83" alt=""></li>
					<li style="float: left; list-style: none; position: relative; width: 1328px;"><img src="../banner/bn_65" alt=""></li>
					<li style="float: left; list-style: none; position: relative; width: 1328px;"><img src="../banner/bn_62" alt=""></li>
					<li style="float: left; list-style: none; position: relative; width: 1328px;"><img src="../banner/bn_61" alt=""></li>
								<!--
					<li id="visual01"">
					...
					-->
					<li style="float: left; list-style: none; position: relative; width: 1328px;" class="bx-clone"><img src="../banner/bn_95" alt=""></li>
				</ul>
			</div>
	...
	.c01_top04 {background:url('./images/pnl_main.png') no-repeat !important;position:relative;}
			...
			<form name="fsmsform" action="" method="post" onsubmit="return checkSubmit(this,'agreen1')">
				<ul class="c01_top">
					...
					<li class="mr_10px c01_top01">
						<div class="visual">
							<div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 333px;"><ul class="bxslider" id="bxslider03" style="width: 415%; position: relative; transition-duration: 0s; transform: translate3d(-544px, 0px, 0px);"><li id="visual02" style="float: left; list-style: none; position: relative; width: 272px;" class="bx-clone">								
									<a href="http://www.pnlskin.com/work/sub03/sub03.php?sb=01"><img src="/images/con04.png" onmouseover="this.src='/images/con04_o.png'" onmouseout="this.src='/images/con04.png'" alt=""></a>
								</li>
								<li id="visual01" "="" style="float: left; list-style: none; position: relative; width: 272px;">
									<a href="http://www.pnlskin.com/work/sub05/sub05.php?sb=01"><img src="/images/con01.png" onmouseover="this.src='/images/con01_o.png'" onmouseout="this.src='/images/con01.png'" alt=""></a>								
								</li>
								<li id="visual02" style="float: left; list-style: none; position: relative; width: 272px;">								
									<a href="http://www.pnlskin.com/work/sub03/sub03.php?sb=01"><img src="/images/con04.png" onmouseover="this.src='/images/con04_o.png'" onmouseout="this.src='/images/con04.png'" alt=""></a>
								</li>
							<li id="visual01" "="" style="float: left; list-style: none; position: relative; width: 272px;" class="bx-clone">
									<a href="http://www.pnlskin.com/work/sub05/sub05.php?sb=01"><img src="/images/con01.png" onmouseover="this.src='/images/con01_o.png'" onmouseout="this.src='/images/con01.png'" alt=""></a>								
					...
					<li class="mr_10px c01_top02">
						<div class="visual">
							<div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 333px;"><ul class="bxslider" id="bxslider04" style="width: 415%; position: relative; transition-duration: 0s; transform: translate3d(-544px, 0px, 0px);"><li id="visual02" style="float: left; list-style: none; position: relative; width: 272px;" class="bx-clone">
									<a href="http://www.pnlskin.com/work/sub09/sub09.php?sb=8_01"><img src="/images/con03.png" onmouseover="this.src='/images/con03_o.png'" onmouseout="this.src='/images/con03.png'" alt=""></a>		
								</li>
								<li id="visual01" "="" style="float: left; list-style: none; position: relative; width: 272px;">
									<a href="http://www.pnlskin.com/work/sub04/sub04.php?sb=01"><img src="/images/con02.png" onmouseover="this.src='/images/con02_o.png'" onmouseout="this.src='/images/con02.png'" alt=""></a>														
								</li>
								<li id="visual02" style="float: left; list-style: none; position: relative; width: 272px;">
									<a href="http://www.pnlskin.com/work/sub09/sub09.php?sb=8_01"><img src="/images/con03.png" onmouseover="this.src='/images/con03_o.png'" onmouseout="this.src='/images/con03.png'" alt=""></a>		
								</li>
					...
					<li class="mr_10px">
					<a href="http://plus.kakao.com/home/@박앤리피부과" target="_blank"><img src="/images/pnl_kakao.png" alt=""></a>
					</li>				
					...
					<input type="image" src="./images/pnl_main_sb.png" class="main_sb">				
					</li>				
				</ul>
				<ul class="c01_bot">
