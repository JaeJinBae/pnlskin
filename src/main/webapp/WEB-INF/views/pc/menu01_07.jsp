	...
	<div id="wrap">
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					<td align="left"><img src="${pageContext.request.contextPath}/resources/img/pc/content/title01_06.gif" border="0"></td>
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; 박앤리 &gt; <span class="home_1">미디어</span></td>
				</tr>
    		  	<tr>
							...
							<form name="lsform" method="post" target="common_iframe" action="<?=$_get[fn]?>/process.php?mode=select_delete">
								<table class="data_list_table data_list_header" background="${pageContext.request.contextPath}/resources/img/pc/common/title_back.gif" border="0">
								     <tr class="text_align_center">
										...
										<td style="width:15%; text-align:center">매체</td><td style="width:10px;"><span class="data_list_header_shell">|</span></td>
