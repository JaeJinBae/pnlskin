...
<body>
	...
	<div id="wrap">
		...
		<div id="l_nav" style="float:left;">
			<div class="l_n_title">모반</div>
			<ul class="l_n_top">
				<li id="sb_01"><a href="${pageContext.request.contextPath}/menu07_01">선천성멜라닌모반</a></li>
				<li id="sb_02"><a href="${pageContext.request.contextPath}/menu07_02">베커모반</a></li>
				<li id="sb_03"><a href="${pageContext.request.contextPath}/menu07_03">화염상모반</a></li>
				<li id="sb_04"><a href="#none">혈관종모반</a></li>
				<li id="sb_05"><a href="${pageContext.request.contextPath}/menu07_05">오타모반</a></li>
				<li id="sb_06"><a href="${pageContext.request.contextPath}/menu07_06">피지샘모반</a></li>
				<li id="sb_07"><a href="${pageContext.request.contextPath}/menu07_07">밀크커피색반점</a></li>
				<li class="cbox"></li>
			</ul>
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					<td align="left" style="width: 50%;"><img src="${pageContext.request.contextPath}/resources/img/pc/content/title07_01.gif" border="0"></td>
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; 모반 &gt; <span class="home_1">선천성멜라닌모반</span></td>
				</tr>
    		  	<tr>
    				<td colspan="2" height="25"></td>
    			</tr>
				<tr>
					<td colspan="2"><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0701.jpg"></td>
				</tr>
				<tr>
