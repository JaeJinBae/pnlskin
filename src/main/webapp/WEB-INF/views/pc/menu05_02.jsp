	...
	<div id="wrap">
		...
		<div id="table_wrap"><!-- contents -->
    		<table width="740" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					<td align="left" style="width: 50%;"><img src="${pageContext.request.contextPath}/resources/img/pc/content/title05_02.gif" border="0"></td>
					<td align="right" class="HOME"><img src="${pageContext.request.contextPath}/resources/img/pc/content/home.gif" align="absmiddle"> &gt; 여드름ㆍ여드름흉터 &gt; <span class="home_1">성인여드름</span></td>
				</tr>
    		  	<tr>
				...
				<tr>
					<td colspan="2" bgcolor="#ffe4ed"><script type="text/javascript">flashWrite('${pageContext.request.contextPath}/resources/img/pc/content/pro_banner3.swf','660','266', 'always', 'transparent', '#ffffff', 'transparent');</script></td>
				</tr>
				<tr>
					<td colspan="2" bgcolor="#ffe4ed" height="30"></td>
				</tr>
				<tr>
					<td colspan="2"><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0501.jpg"></td>
				</tr>
				<tr>
					<td colspan="2"><a name="con0501_b1"></a><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0502_b1.jpg"></td>
				</tr>
				<tr>
					<td colspan="2"><a name="con0501_b2"></a><img src="${pageContext.request.contextPath}/resources/img/pc/content/con0502_b2.jpg"></td>
				</tr>
				<tr>
