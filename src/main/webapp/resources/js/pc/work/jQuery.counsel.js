	...
	//-------- write
		 $("#btn_conf").click(function() {
			  ...
			  /*if( $("textarea[name=content]").val()=="" ) {
				   alert("상담 내용을 입력해 주십시요."); $("textarea[name=content]").focus(); return;
			  }**/
			  ...
			  temp = temp.replace("&nbsp;", "");
			  if(temp == "") { alert("상담 내용을 입력해 주십시요."); ed.focus(); return; }
			  ...
			  if(confirm("작성하신 온라인상담 정보를 "+msg+"하시겠습니까?")) { 
